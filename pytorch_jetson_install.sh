...
git clone https://github.com/nanopb/nanopb.git pytorch/torch/lib/
git clone https://github.com/pybind/pybind11.git pytorch/torch/lib/
git clone https://github.com/facebookincubator/gloo.git pytorch/torch/lib/
cd pytorch/ && pwd
# install prereqs
#
